...
- **Pricing (confirmed 2026-09-07):** monthly bookkeeping from $250/month, flat, no hourly overages (scope boundary still to be defined). Cleanup and catch-up $250/hour, one hour minimum. Individual returns from $250. Business returns from $950. QuickBooks file review free. Turnaround 14 business days. This is a premium position — pages argue outcome, speed and continuity, never price.
